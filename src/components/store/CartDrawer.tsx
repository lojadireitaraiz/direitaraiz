              ...
              <div className="flex-shrink-0 border-t border-border bg-background">
                ...
                <div className="flex items-center justify-between p-4 border-b border-border">
                  ...
                  <div className="flex items-center gap-2">
                    <Input
                      ...
                      className="w-32 h-9 text-center text-sm border-border rounded-full"
                    />
                    <button 
                ...
                <div className="p-4">
                  <Button
                    ...
                    className="w-full bg-black text-white hover:bg-black/90 py-6 text-base font-medium rounded-full"
